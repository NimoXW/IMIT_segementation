...
class Autopet_baseline():  # SegmentationAlgorithm is not inherited in this class anymore
    ...
    def __init__(self):
        ...
        self.nii_path = '/opt/algorithm/nnUNet_raw_data_base/nnUNet_raw_data/Task602_ruijin_160/imagesTs'
        self.result_path = '/opt/algorithm/nnUNet_raw_data_base/nnUNet_raw_data/Task602_ruijin_160/result'
